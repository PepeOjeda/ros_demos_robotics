...
def generate_launch_description():
    ...
    # World to launch:
    world_file = get_share_file_path_from_package(package_name="particle_filter_demo", file_name="demo_warehouse.world.xml")
    rviz_config_file = get_share_file_path_from_package(package_name="particle_filter_demo", file_name="demo_warehouse_ros2.rviz")
    ...
    navigation_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            get_share_file_path_from_package(package_name="particle_filter_demo", file_name="navigation_launch.py")
        )
    )
